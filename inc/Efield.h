...
void eadvance_z(complex<double>*****f,threevector ***B,int nmax,double dt,int gridx,int gridy,int gridz)//Use if monoenergetic due to enhanced stability of the centred trapezium scheme
{
...
void eadvance_xy(complex<double>*****f,threevector ***B,int nmax,double dt,int gridx,int gridy,int gridz)//Use if monoenergetic due to enhanced stability of the centred trapezium scheme
{
  int n,m,xpos,ypos,zpos;
  double emrat = 1.0;//The ratio of the electic charge over the electron mass
  complex<double> CompNul(0.0,0.0);
